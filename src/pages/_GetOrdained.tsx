...
//  import bannerrImg from "/images/shape.png";
  ...
  return (
    <>
      <div className="bg-primary ">
        <Header />
        <div className="md:px-4 relative overflow-x-hidden">
          <div
            className={cn(
              "hidden md:flex items-center justify-center flex-col w-full lg:w-full h-auto  banner-bg mt-[21px] md:mt-0",
        ...
        <div
            className={cn(
              "relative flex md:hidden items-center justify-center flex-col w-full lg:w-full h-auto mt-[21px] md:mt-0",
              " md:px-[16px] lg:px-[11%] xl:px-[15%] py-[11%] "
            )}
            >
              <div className="overflow-hidden absolute top-0 left-[-12px] right-[-12px] ">

              <img src='/images/shape.png' alt="" className="w-full overflow-hidden" />
              </div>
              <p className="text-2xl lg:text-[53.85px] font-normal text-white uppercase pt-[58px] lg:pt-[100px] w-[300px] sm:w-[500px] md:w-[600px] lg:w-auto text-center ">
              Ordination and other cool stuff
            </p>
