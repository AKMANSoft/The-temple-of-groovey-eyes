...
const faqsList = [
  ...
  },
  {
    ...
    content: (
      <>
        <span className="font-bold"> NO!</span> We welcome all atheists, agnostics, and equality-loving spiritual people. Our focus is on the sanctity of here and now, and the holy nature of our own actions in the world. <span className="font-bold">Here is a Holy Place to Be.</span>
      </>
    ),
  },
  {
