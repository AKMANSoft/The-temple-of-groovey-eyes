  ...
  return (
    ...
    <div className="w-full px-4 lg:px-0">
          ...
          >
            ...
            {data.map((data,index)=>(
                <div key={index} className="w-full flex flex-col items-center  text-center gap-5 max-w-[300px] lg:max-w-[810px] mt-5 lg:mt-7">
                    ...
                    <p className="text-sm font-Inter text-white lg:mb-5">
                        {data.content}
                    </p>
                </div> 
